...
fn main() {
    ...
    println!("Nova fixed-point denoise Conv + toy model commitment demo");
    ...
    let placeholder = build_fixed_point_denoise_conv_commitment_placeholder_circuit::<
        N,
        IH,
        IW,
        TE,
    ...
    let circuits = build_fixed_point_denoise_conv_commitment_step_circuits(
        &trace,
        &hash_witnesses,
        num_steps,
        num_iters_per_step,
